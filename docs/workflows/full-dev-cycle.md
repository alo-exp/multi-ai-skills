...
**MANDATORY before `/create-release`** — all four stages in `docs/pre-release-quality-gate.md` must pass in order:
...
```
Do NOT invoke `/create-release` until all four markers are present.
